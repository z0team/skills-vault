---
name: affaan-m__agentic-os
description: "Build persistent multi-agent operating systems on Claude Code. Covers kernel architecture, specialist agents, slash comm"
---
