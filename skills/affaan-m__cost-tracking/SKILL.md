---
name: affaan-m__cost-tracking
description: "Track and report Claude Code token usage, spending, and budgets from the local ECC cost-tracker metrics log. Use when th"
---
