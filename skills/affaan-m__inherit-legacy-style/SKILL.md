---
name: affaan-m__inherit-legacy-style
description: "Legacy-project style inheritance skill. Use when the user types /inherit-legacy-style, or when onboarding an AI coding a"
---
