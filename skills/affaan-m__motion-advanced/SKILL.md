---
name: affaan-m__motion-advanced
description: "Advanced motion patterns for React / Next.js — drag & drop, gestures, text animations, SVG path drawing, custom hooks, i"
---
