---
name: affaan-m__skill-scout
description: "Search existing local, marketplace, GitHub, and web skill sources before creating a new skill. Use when the user wants t"
---
