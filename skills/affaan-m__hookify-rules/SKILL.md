---
name: affaan-m__hookify-rules
description: "This skill should be used when the user asks to create a hookify rule, write a hook rule, configure hookify, add a hooki"
---
