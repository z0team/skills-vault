---
name: affaan-m__email-ops
description: "Evidence-first mailbox triage, drafting, send verification, and sent-mail-safe follow-up workflow for ECC. Use when the "
---
