---
name: affaan-m__connections-optimizer
description: "Reorganize the user's X and LinkedIn network with review-first pruning, add/follow recommendations, and channel-specific"
---
