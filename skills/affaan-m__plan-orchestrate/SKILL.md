---
name: affaan-m__plan-orchestrate
description: "Read a plan document, decompose it into steps, design a per-step agent chain from the ECC catalogue, and emit ready-to-p"
---
