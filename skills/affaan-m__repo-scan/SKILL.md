---
name: affaan-m__repo-scan
description: "Cross-stack source code asset audit — classifies every file, detects embedded third-party libraries, and delivers action"
---
