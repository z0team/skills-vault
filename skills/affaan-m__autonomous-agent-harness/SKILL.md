---
name: affaan-m__autonomous-agent-harness
description: "Transform Claude Code into a fully autonomous agent system with persistent memory, scheduled operations, computer use, a"
---
