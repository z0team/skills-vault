---
name: affaan-m__workspace-surface-audit
description: "Audit the active repo, MCP servers, plugins, connectors, env surfaces, and harness setup, then recommend the highest-val"
---
