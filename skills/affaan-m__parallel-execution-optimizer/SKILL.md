---
name: affaan-m__parallel-execution-optimizer
description: "Use when the user wants a task done much faster through parallel work, concurrent agents, batched tool calls, isolated w"
---
