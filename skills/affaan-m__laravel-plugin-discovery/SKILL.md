---
name: affaan-m__laravel-plugin-discovery
description: "Discover and evaluate Laravel packages via LaraPlugins.io MCP. Use when the user wants to find plugins, check package he"
---
