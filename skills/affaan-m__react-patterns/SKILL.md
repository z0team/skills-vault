---
name: affaan-m__react-patterns
description: "React 18/19 patterns including hooks discipline, server/client component boundaries, Suspense + error boundaries, form a"
---
