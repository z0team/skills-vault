---
name: affaan-m__recsys-pipeline-architect
description: "Design composable recommendation, ranking, and feed pipelines using the six-stage Source→Hydrator→Filter→Scorer→Selector"
---
