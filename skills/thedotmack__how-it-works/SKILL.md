---
name: thedotmack__how-it-works
description: "Explain how claude-mem captures observations, when memory injection kicks in, and where data lives. Use when the user as"
---
