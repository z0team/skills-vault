---
name: affaan-m__terminal-ops
description: "Evidence-first repo execution workflow for ECC. Use when the user wants a command run, a repo checked, a CI failure debu"
---
