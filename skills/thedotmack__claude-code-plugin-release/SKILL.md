---
name: thedotmack__claude-code-plugin-release
description: "Automated semantic versioning and release workflow for Claude Code plugins. Handles version increments across package.js"
---
