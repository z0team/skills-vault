---
name: thedotmack__smart-explore
description: "Token-optimized structural code search using tree-sitter AST parsing. Use instead of reading full files when you need to"
---
