---
name: affaan-m__frontend-design-direction
description: "Set an ECC-specific frontend design direction for production UI work. Use when building or improving websites, dashboard"
---
