---
name: affaan-m__agent-self-evaluation
description: "Use after completing any non-trivial task. The agent self-rates its output on 5 axes — accuracy, completeness, clarity, "
---
