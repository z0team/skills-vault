---
name: affaan-m__orch-fix-defect
description: "Orchestrate fixing a bug — reproduce it as a failing regression test, fix to green, review, and gated commit — by delega"
---
