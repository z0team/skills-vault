---
name: affaan-m__orch-pipeline
description: "Shared orchestration engine for the orch-* skill family. Defines the gated Research-Plan-TDD-Review-Commit pipeline, the"
---
