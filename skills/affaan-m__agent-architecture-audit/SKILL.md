---
name: affaan-m__agent-architecture-audit
description: "Full-stack diagnostic for agent and LLM applications. Audits the 12-layer agent stack for wrapper regression, memory pol"
---
