---
name: thedotmack__standup
description: "Facilitate a read-only standup across git worktrees, branches, or PRs to compare changes and produce one consolidation p"
---
