---
name: affaan-m__error-handling
description: "Patterns for robust error handling across TypeScript, Python, and Go. Covers typed errors, error boundaries, retries, ci"
---
