---
name: affaan-m__ecc-guide
description: "Guide users through ECC's current agents, skills, commands, hooks, rules, install profiles, and project onboarding by re"
---
