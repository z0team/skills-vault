---
name: affaan-m__benchmark-optimization-loop
description: "Use when the user asks to make something faster, try many variants, run recursive optimization, benchmark latency/throug"
---
