...
<!-- skill:octogent:start -->
## Skill: octogent

Multi-agent terminal orchestration framework for Node.js/TypeScript. Use when you need to spawn, coordinate, and manage multiple AI sub-agents across parallel terminal sessions — each with its own scoped context, notes, and task list — from a single Claude Code orchestrator process.
